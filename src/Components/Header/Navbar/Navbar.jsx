        ...
        <div className="flex justify-between pl-3 items-center py-2">
          ...
          <div className="flex justify-between gap-2 items-center text-slate-700 dark:text-white md:space-x-2 md:mr-5">
              ...
              >
                ...
                {searchQuery && (
                  <IoMdClose
                    ...
                    className="absolute right-2 text-gray-500 hover:text-red-500 cursor-pointer text-xl transition dark:text-white"
                  />
                )}
              </form>
            ...
            <button
              ...
              className="text-lg sm:text-2xl ml-2 text-green-800 dark:text-white"
            >
              <FaShoppingCart />
            </button>
