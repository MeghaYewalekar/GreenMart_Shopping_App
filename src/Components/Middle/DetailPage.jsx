  ...
  return (
    <div className="flex px-6 py-10 mx-auto md:mt-10 dark:bg-gray-800">
      <div className=" mx-auto ">
        <div className="flex ">
          <div className="mt-6 text-center">
            <button onClick={() => navigate(-1)}>
              <IoMdArrowRoundBack className="text-3xl md:-mx-28 hover:text-gray-700 hover:scale-x-110 dark:text-white" />
            </button>
          </div>
          <div className="text-3xl font-bold text-center ml-14 mt-16 md:ml-72 mb-8 dark:text-white">
        ...
        <div className="p-4 w-[500px] md:w-[700px] mx-auto shadow-lg rounded-xl bg-gray-100 dark:bg-gray-400">
