...
const PrintPage = () => {
  ...
  return (
    <div className="px-4  md:mb-16">
      <div className="pt-24 ml-20 print:pt-0 ">
        <button onClick={() => navigate(-1)}>
          <IoMdArrowRoundBack className="  text-3xl hover:text-gray-700 hover:scale-x-110 dark:text-white print:hidden" />
        </button>
      </div>
      {/* Invoice Container */}
      <div
        ...
        <div className="flex justify-between items-center border-b pb-4 mb-4">
          <div className="flex items-center">
            <img
              src="/mainlogo.png"
              alt="Company Logo"
              className="h-10 md:h-14 w-auto rounded-lg mr-3"
            />
            <h1 className="text-xl md:text-4xl font-semibold text-gray-900">GreenMart</h1>
          </div>
  ...
  <p>Total: ₹{(totalAmount || 0).toFixed(2)}</p>
        ...
        <div className=" flex justify-center space-x-4 ">
          <button
            onClick={handlePrint}
            className="mt-6 px-5 py-2 bg-green-800 text-white font-semibold rounded-md hover:bg-gray-900 transition print:hidden"
          >
            Print Invoice
          </button>
          <button
            onClick={handleDownloadPDF}
            className="mt-6 px-5 py-2  bg-green-800 text-white font-semibold rounded-md hover:bg-green-700 transition print:hidden"
          >
            Download PDF
          </button>
        </div>
