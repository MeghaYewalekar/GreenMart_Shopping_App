...
import Other from "../../assets/ProductImg/gardener1.jpg";
...
export default function Products() {
  ...
  return (
    <div className="pt-11 dark:bg-gray-950 dark:text-white pb-16">
      <h2 className="text-xl  md:text-4xl font-bold pb-8 text-center">
        Our Collections
      </h2>
      <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-2 mg:gap-6 place-items-center px-9">
