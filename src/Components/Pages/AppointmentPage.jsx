...
const AppointmentPage = () => {
  ...
  return (
    <div>
       <h2 className="text-xl font-bold mb-4 text-center mt-32">Gardener Appointment Page</h2>
    <div className=" max-w-6xl mx-auto p-6 bg-white rounded-lg shadow-md flex justify-center">
