...
export default function Dashboard() {
  ...
  return (
    <div className="flex">
      <AdminSidebar />
      <div className="grid gap-6 grid-cols-1 md:grid-cols-2 lg:grid-cols-4 mt-44 ml-12">
        ...
        {[
          ...
          <div key={index} className="bg-white shadow-md rounded-lg p-3 flex justify-between items-center text-sm md:text-base h-28">
